...
最新发布：[文字战线与妖塔成长补齐](RELEASE_WORD_FRONT_20260914.md)：独立赵云救阿斗 PvE 首期、两张服务端校验榜，以及妖塔升级里程碑和战报优化。原[压力整理与统一导航](RELEASE_RELIEF_NAVIGATION_20260911.md)、[妖塔提案适配](DEMON_TOWER_PROPOSALS_20260911.md)、[灵石经济](DEMON_TOWER_ECONOMY.md)、[成员投稿与站长审核](RELEASE_POSTING_20260910.md)、[深色模式](RELEASE_DARK_MODE_20260910.md)、[工作台与桌宠增强](MY_WORKSPACE.md)能力保留。

更新日期：2026-09-14。先看[项目首页](../README.md)与[当前进度](PROGRESS.md)，再按下面的主题查阅。

截至 2026-09-14 09:42（北京时间）的已验收发布，线上应用为 `9013da770a51044965486efec9b201ae69d5f7e8`，数据库为 schema37，GitHub `main` 已快进同步。确认运行版本、发布结果和回滚边界时，以对应的**正式发布记录**为准；设计文档中的“待验收”或旧提交号是该阶段的历史，不是新的部署指令。后续文档提交不代表重新部署应用。
...
| 文字战线 | [首期交付与验收](RELEASE_WORD_FRONT_20260914.md) | 新玩法独立于原工位塔防；剧情和无尽单独计榜，不发办公币，完整替换/PvP/商店仍待办 |
...
| 九层妖塔 | [v0.8—v0.11 适配](DEMON_TOWER_PROPOSALS_20260911.md)、[当前提案发布](RELEASE_PROPOSALS_20260911.md)、[灵石经济与集中申领](DEMON_TOWER_ECONOMY.md)、[基础玩家指南](DEMON_TOWER_PLAYER_GUIDE.md)、[免费扩展规则](../packages/backend/src/modules/community/demon-tower/EXPANSION.md) | 七个工作区、申领五分类；旧灵石/残魂不扣办公币，新办公币专区明确确认扣款，无真实付费。基础指南不包含全部新规则；v0.11 后续规划未全部完成 |
...
| 新闻与热榜 | [新闻分类](NEWS_CATEGORIES_2026-09-08.md)、[快照机制](TRENDING_NEWS_SNAPSHOTS_2026-09-08.md)、[历史来源验收](RELEASE_COMPLETION_20260909.md#热榜实际验收)、[本次关闭跟进](RELEASE_ECONOMY_20260911.md) | 微博、知乎、抖音仍为外链；微博、知乎反馈按站长要求关闭，保留未接入分项，不宣称站内同步成功 |
...
| 导航入口 | [统一跨页目录与自定义](RELEASE_RELIEF_NAVIGATION_20260911.md)、[历史小游戏与工具直达](RELEASE_NAVIGATION_20260909.md) | 工具、游戏与公开页面保留目录；按账号在当前浏览器排序/隐藏/重置，不跨设备同步，不覆盖工作台收藏或绕过权限 |
...
- [本次压力整理与导航反馈处理](RELEASE_RELIEF_NAVIGATION_20260911.md)：两条均已完成、记录 v3，分别 8/8 与 2/2。17:13 全量只读复核共 23 条，21 完成、1 待审阅、1 进行中；塔防四点仍仅诊断，未把全部协作清空。
- [本次协作反馈处理](RELEASE_WORD_FRONT_20260914.md)：赵云救阿斗首期 3/8、妖塔 v0.11 为 5/11，均保持进行中；战报评级、完整替换、PvP、经济及其他规划未完成。[历史妖塔提案发布](RELEASE_PROPOSALS_20260911.md)保留 v0.8/v0.9/v0.10 的完成证据。
...
本次新增 0037，目前为 38 条迁移历史、148 张 public 表。当前直接回滚应用为 `e183860`：只切 API/Web，保留 schema37、全部新旧成绩与妖塔状态，不执行 DOWN 或旧库回灌；因旧版不能兑现新升级保底，回退期间须暂停妖塔手动写入及自动探索。历史回滚预案不可照抄，详见[本次发布记录](RELEASE_WORD_FRONT_20260914.md)。

## 正式发布记录

同一天的记录按功能发布先后演进，不能只按文件日期判断版本。第一项为当前线上应用，其余为历史发布记录。

| 阶段 | 记录 |
| --- | --- |
| 当前应用：文字战线与妖塔成长，9013da7 | [2026-09-14 文字战线发布](RELEASE_WORD_FRONT_20260914.md) |
