...
最新发布：[九层妖塔经济与统一物资申领](RELEASE_ECONOMY_20260911.md)，集中物资库、残魂秘市、增益符文与最近收支，详见[经济规则](DEMON_TOWER_ECONOMY.md)。原有[成员投稿与站长审核](RELEASE_POSTING_20260910.md)、[深色模式](RELEASE_DARK_MODE_20260910.md)、[工作台与桌宠增强](MY_WORKSPACE.md)能力保留。

更新日期：2026-09-11。先看[项目首页](../README.md)与[当前进度](PROGRESS.md)，再按下面的主题查阅。

截至 2026-09-11 11:44:14（北京时间）的已验收发布，线上应用为 `34260773f613b540bb9fa4257b8112ccbc87d019`，数据库为 schema36，GitHub `main` 已同步。确认运行版本、发布结果和回滚边界时，以对应的**正式发布记录**为准；设计文档中的“待验收”或旧提交号是该阶段的历史，不是新的部署指令。后续文档提交不代表重新部署应用。
...
| 九层妖塔 | [经济与集中申领](DEMON_TOWER_ECONOMY.md)、[当前经济发布](RELEASE_ECONOMY_20260911.md)、[基础玩家指南](DEMON_TOWER_PLAYER_GUIDE.md)、[免费扩展规则](../packages/backend/src/modules/community/demon-tower/EXPANSION.md) | 灵石与残魂、办公币独立；旧来源和兑换保留。基础指南不是全部当前掉落及经济规则 |
...
- [本次经济发布与反馈处理](RELEASE_ECONOMY_20260911.md)：经济反馈完成 8 项，微博、知乎按站长要求关闭跟进但保留 2 个未接入分项；仅更新这两条反馈，不是全站新建议重新扫描。一名指定成员获开发协作授权，不是管理员。
...
摸鱼指数与支持台账发布新增 0036，当前仍为 37 条迁移历史、148 张 public 表；本次妖塔经济没有 SQL 迁移。新增经济状态在旧应用中不具备安全写入兼容性，回滚 `2111004` 须暂停妖塔与自动探索、保留新增 JSON，投稿与审核保持开启，不恢复旧库覆盖数据。历史发布中的迁移 DOWN、成员授权及权益赠送不能照抄到生产，具体按当前发布预案执行。
...
| 阶段 | 记录 |
| --- | --- |
| 当前应用：妖塔经济与统一物资申领，3426077 | [2026-09-11 经济发布](RELEASE_ECONOMY_20260911.md) |
