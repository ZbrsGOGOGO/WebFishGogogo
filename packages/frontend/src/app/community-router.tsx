...
const WordFrontMapStudioPage = lazy(() => import('../features/workstation-tower-defense/word-front/WordFrontMapStudioPage').then(module => ({ default: module.WordFrontMapStudioPage })));
    ...
    <Routes>
      <Route element={<CommunitySiteLayout />}>
        ...
        <Route element={<RequireCommunityAccount />}>
          ...
          <Route path="/tower-defense/word-front/maps" element={COMMUNITY_FEATURE_FLAGS.towerDefense ? loading(<WordFrontMapStudioPage />) : <CommunityUnavailablePage system="towerDefense" />} />
