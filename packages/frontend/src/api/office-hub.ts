...
const messages: Record<string, string> = {
        OFFICE_DRAWING_ACTIVE: '你已有进行中的画作，请继续当前题目',
        OFFICE_DRAWING_DAILY_LIMIT: '当前服务器仍使用旧版每日创作规则，请刷新同步后再领取主题',
        OFFICE_DRAWING_CAPACITY: '画作保存容量已满，暂不能领取主题；可以撤下本人旧画释放空间，或稍后刷新核对',
        OFFICE_DRAWING_GLOBAL_CAPACITY: '猜画墙已达保存保护上限，暂不能领取新主题；请稍后刷新或联系管理员整理，不是每日次数限制',
        OFFICE_DRAWING_PARTICIPANT_CAPACITY: '这幅画的互动记录已达保护上限，请选择其他同事的画作',
        OFFICE_DRAWING_RATING_INVALID: '请选择 1–5 分的整数评分',
        OFFICE_DRAWING_RATE_PARTICIPATION_REQUIRED: '先为这幅画提交一次猜题，再进行评分；不要求猜中',
        OFFICE_SELF_RATE: '不能给自己的画评分',
        OFFICE_DRAWING_VERSION_CONFLICT: '草稿已在其他页面更新；请读取服务器草稿后继续，未覆盖已保存的笔画',
        OFFICE_DRAWING_REVISION_INVALID: '草稿版本无效，请重新读取当前画作',
        OFFICE_DISABLED: '公司工作台尚未开放，请稍后再来', OFFICE_ALREADY_CLAIMED: '这一份奖励已经领取过了', OFFICE_TICKETS_LOW: '限定券不足，可领取每日券或用社交积分兑换',
        OFFICE_EXP_LOW: '农场额度不足 100，或今天已经完成 20 抽', OFFICE_EXCHANGE_LIMIT: '需要 50 社交积分，每天最多兑换 2 张', OFFICE_RATE_LIMIT: '操作稍快，请稍后再试',
        ...
        OFFICE_ALREADY_ACTED: '本轮已经提交过，刷新即可看到结果', OFFICE_SELF_RATING: '不能给自己的续写评分', OFFICE_SELF_GUESS: '请猜其他同事的作品', OFFICE_DRAWING_EXPIRED: '绘画时间已结束，请查询服务器结算结果', OFFICE_GUESS_LIMIT: '已猜中或本题的 5 次机会已用完',
