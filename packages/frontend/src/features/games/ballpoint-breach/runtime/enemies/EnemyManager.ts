...
import { getEnemySharedResources } from './doodleRig';
...
export class EnemyManager {
  ...
  remove(id: string): boolean {
    ...
    disposeObjectResources(enemy.object, {
      geometries: new Set(shared.geometries),
      materials: new Set(shared.materials),
    });
