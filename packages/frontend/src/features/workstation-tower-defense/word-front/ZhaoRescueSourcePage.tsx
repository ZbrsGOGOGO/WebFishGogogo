...
export function ZhaoRescueSourcePage():JSX.Element {
  ...
  return <main className={styles.page}><header><div><span>SOURCE EDITION / V6</span><h1>赵云救阿斗</h1><p>已按你提供的源码同源自托管：原版棋盘、武将、武器、章节、自动战斗与图鉴完整保留。</p></div><nav><Link to="/tower-defense">工位塔防</Link><Link to="/tower-defense/word-front/rooms">玩家房间</Link><Link to="/tower-defense/word-front/v4">V4 赛季与排行</Link><Link to="/games">小游戏</Link></nav></header>
