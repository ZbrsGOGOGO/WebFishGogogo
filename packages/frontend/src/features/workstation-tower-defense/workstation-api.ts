import type { WorkstationCommand, WorkstationJob, WorkstationMode, WorkstationOverview, WorkstationTalentPlanInput } from '@stealth-reader/shared';
...
export const workstationApi = {
  ...
  talents: (input: WorkstationTalentPlanInput): Promise<WorkstationOverview> => communityHttp.post(`${ROOT}/talents`,input,{retryAfterRefresh:false}),
