  ...
  return (
    <main aria-labelledby="privacy-policy-title" className="compliance-page">
      ...
      <p>
        ...
        {includeGames
          ? '本网站提供公开内容、浏览器本地效率工具、轻量单机游戏和“摸鱼升职记”工位塔防试玩，不要求用户注册账户，也不提供在线支付或个性化推荐。'
      ...
      {includeGames ? (
        <p>
          部分单机游戏会使用浏览器本地存储保存最高分；工位塔防只会在本机保存最高分，
          不会上传到本站服务器，也不会发放账号经验或货币。旧乐斗本机存档不会被新玩法读取或换算，
          您可以通过浏览器的网站数据设置随时删除这些记录。
        </p>
      ) : null}
