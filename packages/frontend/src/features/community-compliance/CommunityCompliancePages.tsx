  ...
  return (
    <main className="compliance-page">
      ...
      <ul>
        ...
        <li>主动建立九层妖塔档案后，服务器保存角色等级、武器技能、配装、探索战报、操作回执与协作贡献，用于跨设备恢复和防止重复结算；不会读取本机其他文件。</li>
      ...
      <p>九层妖塔的个人存档和详细配装不公开；参与世界首领或通道建设后，昵称、随机公开编号、妖塔等级及贡献可出现在公开贡献榜。公共楼层进度由参与者共同推进。</p>
      <h2>保存与权利</h2>
      <p>业务数据按提供服务所需期限保存，网络安全与争议记录按适用要求隔离保存。用户可以访问、更正、调整公开范围、退出设备或申请注销账号。</p>
      <p>九层妖塔数据说明（2026-09-08）：完成账号注销时清理个人游戏存档、操作回执与个人榜单记录；已形成的匿名公共进度和必要资产账本保留，不撤销其他玩家已获得的进度。是否开放注销申请，以账号安全页面的当前状态为准。</p>
      <ComplianceNav />
    </main>
  );
}
...
export function CommunityTermsOfServicePage(): JSX.Element {
  return (
    <main className="compliance-page">
      ...
      <p>九层妖塔是免费账号养成与协作玩法，角色等级和材料独立于全站成长，办公币奖励以服务器规则与每日上限为准。没有充值、付费战力、现金兑换或收益承诺；断网或重复提交不会重复发奖。</p>
      <h2>处置与申诉</h2>
