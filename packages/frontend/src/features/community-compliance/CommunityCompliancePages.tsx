...
export function CommunityPrivacyPolicyPage(): JSX.Element {
  return (
    <main className="compliance-page">
      ...
      <h2>我们处理的信息</h2>
      <ul>
        <li>账号资料：登录账号、加盐哈希后的密码、昵称、随机公开编号、系统头像和乐斗职业。平台不保存明文密码。</li>
        <li>安全信息：会话摘要、登录时间、大致地区、风险事件和必要网络安全日志。</li>
        <li>用户主动产生的数据：主页设置、通知状态、好友关系、公开内容、农场记录和乐斗资产。</li>
      ...
      <h2>公开范围</h2>
      <p>昵称、系统头像、乐斗职业和公开帖子可对所有人可见；装备、绿植、荣誉等默认仅好友可见。登录账号、手机号、身份信息和登录设备始终不公开。</p>
      <h2>保存与权利</h2>
...
export function CommunityTermsOfServicePage(): JSX.Element {
  return (
    <main className="compliance-page">
      ...
      <h2>服务边界</h2>
      <p>本站提供轻量工具、小游戏、交流、农场和办公室乐斗等功能。办公室乐斗职业仅是虚构玩法，不代表对现实职业、能力或身份的评价。匿名试玩奖励不能迁移为正式账号资产。</p>
      <h2>处置与申诉</h2>
