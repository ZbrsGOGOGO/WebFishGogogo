...
function showText(text) {
	var messages = {
		...
		'pausedAndroid': "<div class='centeredHeader unselectable'>已暂停 · 点击继续</div>",
		'pausediOS': "<div class='centeredHeader unselectable'>已暂停 · 点击继续</div>",
		'pausedOther': "<div class='centeredHeader unselectable'>已暂停 · P / 空格继续</div>",
...
function gameOverDisplay() {
	...
	/* No tracking cookie is created in the opaque sandbox. */
