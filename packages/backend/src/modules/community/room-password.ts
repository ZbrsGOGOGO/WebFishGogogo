 ...
 */
export async function consumeRoomPasswordAttempt(db: DataSource, module: 'play' | 'rail' | 'paper' | 'word-front', userId: string, roomId: string, now = new Date()): Promise<void> {
