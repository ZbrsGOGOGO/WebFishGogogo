...
export const ARCADE_GAME_KEYS = ['tetris', 'tank', 'zhesi', 'word_story', 'word_endless', 'word_story_v2', 'word_endless_v2'] as const;
...
@Check('chk_arcade_game_runs_game', `"game_key" IN ('tetris', 'tank', 'zhesi', 'word_story', 'word_endless', 'word_story_v2', 'word_endless_v2')`)
...
@Check('chk_arcade_best_scores_game', `"game_key" IN ('tetris', 'tank', 'zhesi', 'word_story', 'word_endless', 'word_story_v2', 'word_endless_v2')`)
