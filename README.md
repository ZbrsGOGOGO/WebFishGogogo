...
- **当前已上线应用为 `0b991be`**，2026-09-10 11:48（北京时间）发布「摸鱼指数、六级头衔与期权持有者支持台账」。[发布与验收记录](docs/RELEASE_FISH_SUPPORT_20260910.md)
- **数据库：schema `0036`**，37 条迁移、148 张 public 表。新增两张空表，不回写旧玩家资产或赠送期限。
