...
- **当前已上线应用为 `57345dd`**，2026-09-10 17:04（北京时间）发布「我的工作台与桌宠增强」，包含全路由计时、今日办公币流水、图片编辑和本机备份。[发布与验收记录](docs/RELEASE_WORKSPACE_20260910.md)
- **数据库：schema `0036`**，37 条迁移、148 张 public 表；本次前端及只读流水接口，无迁移，不改赠送期限。[摸鱼指数与支持台账发布](docs/RELEASE_FISH_SUPPORT_20260910.md)保留追溯。
