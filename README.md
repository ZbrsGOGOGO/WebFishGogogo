...
- **当前 Web 为 `2b7b8d9`，API 仍为 `832f528`**。2026-09-15 16:30:24（北京时间）仅发布网页第三阶段：新增六款自托管原版小游戏与低调工作稿小窗、精选筛选；21 个既有入口保留，目录共 27 个入口。第一、第二阶段的首页/导航、个人档案与成长收藏保留，不改变经济或权限。[发布与验收记录](docs/RELEASE_GAME_PACK_20260915.md) · [分阶段路线图](docs/UI_ROADMAP_20260915.md)
- **数据库：schema `0039`**，40 条迁移、148 张 public 表；本次无迁移，API、PostgreSQL、Redis、网关容器保持不变。原有[协作反馈修复](docs/RELEASE_FEEDBACK_20260914.md)、[文字战线 v3 与免费双人房](docs/RELEASE_WORD_FRONT_V3_20260914.md)、投稿、成长和桌宠能力保留，完整提案仍未全部完成。
...
| 九层妖塔 | 免费角色成长、八部位形象、配装参考战力、真实好友切磋与共享首领；探索统计/符、统一物资申领、办公币补给与养成手册；有效期权持有者权益可解锁自动探索 | `/games/demon-tower`、`/games/demon-tower?tab=shop` |
