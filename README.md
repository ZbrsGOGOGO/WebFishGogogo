...
- **当前已上线应用为 `3426077`**，2026-09-11 11:44:14（北京时间）发布九层妖塔经济与统一物资申领：灵石、残魂、办公币分列，物资库、秘市、增益符文与收支集中管理；手机深色导航与深链接定位同时修复。[发布与验收记录](docs/RELEASE_ECONOMY_20260911.md) · [经济与申领规则](docs/DEMON_TOWER_ECONOMY.md)
...
| 九层妖塔 | 免费角色成长、探索与共享首领；统一物资申领、灵石补给、永久加成、符文和收支；有效期权持有者权益可解锁自动探索 | `/games/demon-tower`、`/games/demon-tower?tab=shop` |
...
- 新闻只保存允许展示的标题/摘要与来源信息，不镜像整篇原文。受上游限制的微博、知乎、抖音等来源保留清楚标记的官方入口，不声称已完成全部站内热榜接入；本次按站长要求关闭微博、知乎的继续跟进，不等于已接入。[热榜边界](docs/TRENDING_NEWS_SNAPSHOTS_2026-09-08.md) · [本次处理记录](docs/RELEASE_ECONOMY_20260911.md)
