...
- **当前已上线应用为 `9413977`**，2026-09-11 14:41:39（北京时间）发布妖塔提案适配：八部位形象、当前配装战力、真实好友切磋、探索统计与探索符、办公币补给/阶梯宝箱/技能碎片和统一养成手册。保持七个工作区，物资申领集中为五个分类。[发布与验收记录](docs/RELEASE_PROPOSALS_20260911.md) · [适配规则与后续范围](docs/DEMON_TOWER_PROPOSALS_20260911.md)
