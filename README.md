...
> 版本边界：线上站点 <https://zbrshyyzxx.top> 已部署当前分支的“摸摸公司”、账号安全、好友实时私聊、四款小游戏与《遮司》账号战力榜；生产数据库已迁移至 `0025`，无凭据公网烟测已通过。

> 塔防范围边界：当前只落地“唯一角色 + 三类塔 + 三波敌人”的短局核心。放置离线收菜、升职成长和公司社交是后续路线，本版本不宣称已实现。
