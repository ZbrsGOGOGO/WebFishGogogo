...
- **当前已上线应用为 `4840700`**，2026-09-10 14:35（北京时间）发布「免费自定义工位搭子」，包含工具页直接刷新恢复修正。[发布与验收记录](docs/RELEASE_DESK_PET_20260910.md)
- **数据库：schema `0036`**，37 条迁移、148 张 public 表；本次仅前端功能，无迁移，不改玩家资产或赠送期限。[摸鱼指数与支持台账发布](docs/RELEASE_FISH_SUPPORT_20260910.md)保留追溯。
...
| 工位搭子 | 免费本机桌宠：自选图片、四种风格、拖动/摸头/喂食/睡觉、安静与专注避让；图片不上传、不跨设备同步 | `/desk-pet` |
