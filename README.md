...
> 版本边界：仓库中的《摸鱼升职记》工位塔防是 **待部署版本**。截至 2026-09-04，线上站点 <https://zbrshyyzxx.top> 仍运行上一版“ZBRS 技术工具工坊 / 办公室乐斗”；只有完成发布和线上烟测后，才能将线上状态改为摸摸公司与工位塔防。
...
- 九系统页面、通知中心、内容治理、固定聊天室、新闻编辑台和《摸鱼升职记》纯浏览器工位塔防。
