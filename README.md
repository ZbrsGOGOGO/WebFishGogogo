...
- **当前 Web 为 `cd11419`，API 仍为 `832f528`**。2026-09-15 15:12:40（北京时间）仅发布网页第二阶段：个人工作台与公开档案统一、成长收藏分类/搜索、称号确认和权益/台账整理；保留第一阶段的导航、按需 3D 首页与 21 个游戏入口，不新增游戏或经济规则。[发布与验收记录](docs/RELEASE_UI_PHASE2_20260915.md) · [分阶段路线图](docs/UI_ROADMAP_20260915.md)
...
| 小游戏与玩家房间 | 21 个既有入口，按单机/房间/养成/本地练习筛选与搜索，明确设备、进度与参榜边界 | `/games`、`/games/rooms` |
