...
- **当前已上线应用为 `49071c8`**，2026-09-10 18:40（北京时间）发布深色模式：页头可选浅色、深色或跟随系统，本机记忆并同步同浏览器标签页；沿用统一工作台与搜索目录。[发布与验收记录](docs/RELEASE_DARK_MODE_20260910.md) · [界面规范](docs/INTERFACE_DESIGN.md)
- **数据库：schema `0036`**，37 条迁移、148 张 public 表；本次仅前端，无迁移，不改赠送期限。原有工作台流水、计时与桌宠能力保留，[前一版发布](docs/RELEASE_WORKSPACE_20260910.md)供追溯。
