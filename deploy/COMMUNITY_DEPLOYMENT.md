...
本批实现范围见 [补齐记录](../docs/FEEDBACK_INTEGRATION_20260909.md)。以生产 `727576bb8312889da3eae0795995848da787dc95` 为应用回退基线，**schema32 → schema32，无 SQL 迁移**；不得照搬下方历史迁移、VIP 赠送或旧成员授权步骤。验证、备份及最终部署结果以本批发布记录为准，不能仅凭本文认为已经上线。
