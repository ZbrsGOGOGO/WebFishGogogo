...
### 2026-09-10 新候选：摸鱼指数与支持台账

新增迁移 **1700000000036**，schema35 → schema36：仅新增时长汇总与支持台账两表，旧 146 表及赠送记录不回写。下表保留切换前 f46 基线，不代表新候选已经发布。具体规则与兼容边界见[摸鱼指数与期权持有者](../docs/COMMUNITY_FISH_SUPPORT.md)，实际上线结果另记发布记录。
