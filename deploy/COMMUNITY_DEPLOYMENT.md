...
本次新增功能的实施与验证范围见 [成长系统说明](../docs/COMMUNITY_PROGRESSION_20260909.md)，正式发布结果单独登记；下方旧版“已部署”不代表本次已经上线。当前应用回滚基线是 `82b84312d01cd9174441dc4a5ac45d9e56ea5a71`，目标迁移 **`0030 → 0031 → 0032`**，仅新增会员赠送、成就解锁、佩戴展示、妖塔自动委托四表。
