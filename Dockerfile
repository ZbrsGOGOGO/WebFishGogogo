...
ARG VITE_COMMUNITY_DEMON_TOWER_ENABLED=false
ARG VITE_COMMUNITY_PROGRESSION_ENABLED=false
ARG VITE_DEMON_TOWER_AUTO_EXPLORE_ENABLED=false
ARG VITE_WORKSTATION_CAMPAIGN_ENABLED=false
ARG VITE_OFFICE_HUB_ENABLED=false
ARG VITE_DEMON_TOWER_EXPANSION_ENABLED=false
ARG VITE_PAPER_ARENA_ENABLED=false
ARG VITE_WORD_FRONT_ROOMS_ENABLED=false
...
ENV VITE_API_BASE_URL=${VITE_API_BASE_URL} \
    ...
    VITE_COMMUNITY_DEMON_TOWER_ENABLED=${VITE_COMMUNITY_DEMON_TOWER_ENABLED} \
    VITE_COMMUNITY_PROGRESSION_ENABLED=${VITE_COMMUNITY_PROGRESSION_ENABLED} \
    VITE_DEMON_TOWER_AUTO_EXPLORE_ENABLED=${VITE_DEMON_TOWER_AUTO_EXPLORE_ENABLED} \
    VITE_WORKSTATION_CAMPAIGN_ENABLED=${VITE_WORKSTATION_CAMPAIGN_ENABLED} \
    VITE_OFFICE_HUB_ENABLED=${VITE_OFFICE_HUB_ENABLED} \
    VITE_DEMON_TOWER_EXPANSION_ENABLED=${VITE_DEMON_TOWER_EXPANSION_ENABLED} \
    VITE_PAPER_ARENA_ENABLED=${VITE_PAPER_ARENA_ENABLED} \
    VITE_WORD_FRONT_ROOMS_ENABLED=${VITE_WORD_FRONT_ROOMS_ENABLED} \
