...
- 生产固定到已验收的应用提交/镜像，不跟随 `main` 自动拉取；截至 2026-09-10 17:04，应用为 `57345dd5dbe510fc74f771e887f61afaa1ef8816`、schema36（我的工作台与桌宠增强）。本次无迁移，直接回滚基线 `4840700` 已认识 schema36，不照搬早期 f46 回退的账号注销关停规则；保留分离存储的本机图片，不重放赠送或真实成员授权。详情见 `docs/RELEASE_WORKSPACE_20260910.md`。
